...
public class TopicUnpublishHandler extends BasePcActionHandler {
    ...
    protected ControlForward execute() throws Exception {
        ...
        if ( topic == null ) {
            ...
            topic = null;
            app.addErrorMessage(lang.getMessage(
                    TxbbLangConstants.ERROR_CAN_NOT_UNPUBLISH_UNOWNED_TOPIC,
                    topicId));
            ...
            if ( form != null && doUnpublishTopic(form) ) {
                String message =
                        lang.getMessage(
                                TxbbLangConstants.MSG_PC_TOPIC_UNPUBLISH_SUCCESSFUL,
