...
public class GscPermissionConstants {

    public final static DafPermission PERMISSION_VIEW_BOX =
            new DafPermission(GscConstants.MODULE_KEY_NAME, "VIEW_BOX",
