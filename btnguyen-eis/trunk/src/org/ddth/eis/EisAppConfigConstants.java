...
public class EisAppConfigConstants {
    public final static AppConfigKey CONFIG_SITE_NAME        = AppConfigKey
                                                                     .createAppConfigKey("SITE",
                                                                                         "NAME");

    public final static AppConfigKey CONFIG_SITE_TITLE       = AppConfigKey
                                                                     .createAppConfigKey("SITE",
                                                                                         "TITLE");
    ...
    public final static AppConfigKey CONFIG_SITE_SLOGAN      = AppConfigKey
                                                                     .createAppConfigKey("SITE",
                                                                                         "SLOGAN");
}
