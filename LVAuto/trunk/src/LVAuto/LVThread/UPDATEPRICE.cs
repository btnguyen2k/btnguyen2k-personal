    ...
    class UPDATEPRICE {
		...
		private void mainprocess()
		{
            try
            {
                ...
                {
                    if (Command.Build.SelectBuilding(Command.CityObj.City.AllCity[0].id, 11, LVAuto.Web.LVWeb.CurrentLoginInfo.MakeCookiesString(Command.CityObj.City.AllCity[0].id)))
                    {
